...
mtx <- mtx[ , apply(mtx.sumstat, 2, function(x) sum(abs(x)) != 5)] # REmove those that have all "1" or "-1"# Optional: adjust columns for multiple testing, if not already done. See utils.R for the function definition.
# mtx<-mtx.adjust(mtx) 
